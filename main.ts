...
let names = ["sabahat", "taufeeq", "muneeba", "haseeb"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
let message: string = "which is your favorite movie.....?";
...
let guestArr : string [] = ["sana", "saba", "sara"];
guestArr.map((items)=> (console.log(`dear ${items}, you are to the dinner`)));
...
console.log( "enjoy your Sandwiches order dear mam sabahat" )
